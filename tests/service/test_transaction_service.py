...
def test_get_transactions_by_user(app, setup, db_session):
    with app.app_context():
        user = setup['user']
...
def test_get_transactions_by_portfolio(app, setup, db_session):
    with app.app_context():
...
def test_get_transactions_by_ticker(app, setup, db_session):
    with app.app_context():
